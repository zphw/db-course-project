...
export const customersOnlyTakeACertainFuknAirline = async (airline: string) => {
    const [rows] = await connection.promise().query(
...
export const ticketsSoldInterval = async (airline: string, start: string, end: string) => {
    const [rows] = await connection.promise().query(
...
export const ticketsSoldTotal = async (airline: string, start: string, end: string) => {
    const [rows] = await connection.promise().query(
...
export const revenueTotal = async (airline: string, start: string, end: string) => {
    const [rows] = await connection.promise().query(
